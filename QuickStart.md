...
2.  Разместите в ней необходимые для проекта [файлы технологий реализации блока](https://ru.bem.info/method/filesystem/) (`CSS`, `JS`, `BEMHTML`). Название директории блока и вложенных в неё файлов должны совпадать с именем блока, которое прописано в BEMJSON-файле. 

    **hello.js** - описывает динамическую функциональность страницы  
...
```
[Полный код BEMJSON-файла](https://gist.github.com/4exova/981a36cedceffa472742).
